...
public class StudentLibrary {
    public static void main(String[] args) {
        // Create instances for student and book management
        /**
         * Creates an instance of the StudentManagement class and assigns it to a variable of type MjStudentManagement.
         * This object can be used to manage student-related operations such as adding, removing, or updating student records.
         */
        MjStudentManagement studentMgmt = new StudentManagement();
        BookManagement bookMgmt = new BookManagement();
